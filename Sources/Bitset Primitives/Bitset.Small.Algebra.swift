...
extension Bitset.Small.Algebra {
    ...
    @inlinable
    public func union(_ other: Bitset.Small<inlineWordCount>) -> Bitset.Small<inlineWordCount> {
    ...
    @inlinable
    public func intersection(_ other: Bitset.Small<inlineWordCount>) -> Bitset.Small<inlineWordCount> {
        var result = Bitset.Small<inlineWordCount>()
    ...
    @inlinable
    public func subtract(_ other: Bitset.Small<inlineWordCount>) -> Bitset.Small<inlineWordCount> {
        var result = Bitset.Small<inlineWordCount>()

        if storedCapacity > Bitset.Small<inlineWordCount>.inlineCapacity {
...
extension Bitset.Small {
    ...
    @inlinable
    public mutating func form(_ operation: (Algebra) -> Bitset.Small<inlineWordCount>) {
